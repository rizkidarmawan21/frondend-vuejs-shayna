                                ...
                                <li class="cart-icon">
                                    ...
                                    <div class="cart-hover">
                                        <div class="select-items">
                                            <table>
                                                <tbody v-if="keranjangUser.length > 0">
                                                    <tr v-for="(keranjang, i) in keranjangUser" :key="keranjang.id">
                                                        <td class="si-pic">
                                                        ...
                                                        <td @click="removeItem(i)" class="si-close">
                                                            <i class="ti-close"></i>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                        ...
                                        <div class="select-button">
                                            ...
                                            <a href="#" class="primary-btn checkout-btn"><router-link to="/cart" style="color:white">CHECK OUT</router-link></a>
                                        </div>
                                    </div>
                                </li>
                            </ul>
